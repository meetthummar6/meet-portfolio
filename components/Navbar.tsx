...
const Navbar = (
  ...
  return (
    <div className="flex justify-between items-center fixed bg-white h-20 w-full py-5 px-2 border-b sm:px-16">
      <div className="flex justify-start items-center gap-4">
        <div className="relative h-12 w-12">
          <Image
            ...
            alt="logo"
            fill
            className="absolute object-cover rounded-full ring ring-indigo-500"
          />
        </div>
